...
This package accompanies the submitted master's thesis:
...
**Master Thesis Replication Repository**

https://github.com/consultingmikus-hue/ThesisMobilityAgentSimulation-Replication

The public GitHub repository contains the complete simulation framework, source code, experiment scripts, documentation, and instructions required to reproduce the reported results.
